...
```
cd existing_repo
git remote add origin https://gitlab.liu.se/vikli788/vti-projekt.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.liu.se/vikli788/vti-projekt/-/settings/integrations)
