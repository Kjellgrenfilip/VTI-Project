...
- The application window can be resized during runtime, and all graphics will scale according to the new window size. However the speedometer will not scale but instead remain the same size. 
