...
Item
{
   ...
   Grid
   {
        ...
        Button
        {
            ...
            onPressed: buttonHandler.pontUpClicked()
        ...
        Button
        {
            ...
            onPressed: buttonHandler.pontDownClicked()
            states:
                [
                State
                {
        ...
        Button
        {
            ...
            text: "H-BRYT"
            onPressed: buttonHandler.mainBreakerClicked()
            states:
                [
                State
                {
        ...
        Button
        {
            ...
            text: "TÅGV."
            onPressed: buttonHandler.heatingClicked()
            states:
                [
                State
                {
